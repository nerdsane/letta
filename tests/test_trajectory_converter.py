...
def mock_messages():
    ...
    assistant_msg.content = [Mock(type="text", text="Once upon a time...")]
    ...
    tool_call_msg.tool_calls = [Mock(id="call-1", type="function", function=tool_call_function)]
...
async def test_message_content_structured_format(converter, mock_run, mock_steps):
    ...
    message_with_content.content = [Mock(type="text", text="First part"), Mock(type="reasoning", text="Internal thought")]
